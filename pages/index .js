    ...
    <>
      ...
      <section id="pricing" className="pricing">
        <div className="pricing-header">
          ...
          <h3 className="pricing-headline">One subscription. <em>Five devices, all at once.</em></h3>
          <p className="pricing-sub">One account, signed in on up to five devices at the same time. Cancel anytime.</p>
        </div>
        <div className="plan-single">
          ...
          <div className="plan-right">
            ...
            <ul className="plan-features">
              ...
              <li><b>Five simultaneous logins</b> — same account, signed in on up to 5 devices at the same time</li>
      ...
      <style jsx>{`
        ...
        .module-grid{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:var(--rule);border:1px solid var(--rule);}
        .module{background:var(--paper);padding:36px 32px 40px;position:relative;transition:background .25s;min-height:340px;display:flex;flex-direction:column;}
